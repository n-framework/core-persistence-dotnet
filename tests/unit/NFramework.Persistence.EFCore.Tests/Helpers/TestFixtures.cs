...
{
    /// <summary>
    /// Creates a new In-Memory TestDbContext.
    /// </summary>
    public static TestDbContext Create() => TestDbContextFactory.CreateInMemory();

    /// <summary>
    /// Creates a new SQLite-backed TestDbContext.
    /// </summary>
    public static TestDbContext CreateSqlite() => TestDbContextFactory.CreateSqlite();
